...
<div class="table-profile">
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <strong>Available Hours: </strong> Monday to Friday, from ${startTime}:00 to ${endTime}:00
        </li>
    </ul>
</div>
<span class="button-center">
    ...
    <button type="button" class="btn btn-info button-doctor-list"><a href="${updateInfo}">Update Information</a></button>
</span>
