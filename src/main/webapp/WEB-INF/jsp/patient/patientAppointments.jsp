      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Do you want to cancel your appointment for ${appointment.key.dayOfWeek} at ${appointment.key.startingTime} with Dr:  ${appointment.value.firstName} ${appointment.value.lastName} ?</p>
          </div>
